...
public class QTableColumnItemProvider
	...
	/**
	 * se l'alias della tabella � specificato: <alias_tabella>.<nome_colonna> {AS <alias_colonna>}
	 * se l'alias della tabella non � specificato: <nome_tabella>.<nome_colonna> {AS <alias_colonna>}
	 * @param qtc
	 * @return
	 * @generated NOT
	 */

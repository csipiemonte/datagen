...
public class LookupResolverItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LookupResolver_foreignKey_feature", "_UI_LookupResolver_type"),
				 DatagenPackage.Literals.LOOKUP_RESOLVER__FOREIGN_KEY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_LookupResolver_supplierDAO_feature", "_UI_LookupResolver_type"),
				 DatagenPackage.Literals.LOOKUP_RESOLVER__SUPPLIER_DAO,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		return getString("_UI_LookupResolver_type");
	}

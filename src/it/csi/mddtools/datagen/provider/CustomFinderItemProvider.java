...
public class CustomFinderItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DatagenPackage.Literals.CUSTOM_FINDER__QUERY_DEFINITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CustomFinder.class)) {
			...
			case DatagenPackage.CUSTOM_FINDER__CUSTOM_FROM:
				...
				return;
			case DatagenPackage.CUSTOM_FINDER__QUERY_DEFINITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DatagenPackage.Literals.CUSTOM_FINDER__QUERY_DEFINITION,
				 DatagenFactory.eINSTANCE.createQueryDef()));
	}

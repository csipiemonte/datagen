...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.datagen.Erdesignerschema30.ViewType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewType_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewType_comment_feature", "_UI_ViewType_type"),
				 erdesignerschema30Package.Literals.VIEW_TYPE__COMMENT,
				 true,
				 false,
				 false,
	...
	protected void addSqlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewType_sql_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewType_sql_feature", "_UI_ViewType_type"),
				 erdesignerschema30Package.Literals.VIEW_TYPE__SQL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewType_id_feature", "_UI_ViewType_type"),
				 erdesignerschema30Package.Literals.VIEW_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 erdesignerschema30Package.Literals.VIEW_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSchemaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewType_schema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewType_schema_feature", "_UI_ViewType_type"),
				 erdesignerschema30Package.Literals.VIEW_TYPE__SCHEMA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(erdesignerschema30Package.Literals.VIEW_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((ViewType)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(erdesignerschema30Package.Literals.VIEW_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(erdesignerschema30Package.Literals.VIEW_TYPE__PROPERTY,

...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.datagen.Erdesignerschema30.IndexType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndexTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndexType_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndexType_id_feature", "_UI_IndexType_type"),
				 erdesignerschema30Package.Literals.INDEX_TYPE__ID,
				 true,
				 false,
				 false,
	...
	protected void addIndextypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndexType_indextype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndexType_indextype_feature", "_UI_IndexType_type"),
				 erdesignerschema30Package.Literals.INDEX_TYPE__INDEXTYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 erdesignerschema30Package.Literals.INDEX_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(erdesignerschema30Package.Literals.INDEX_TYPE__GROUP);
		}
	...
	public String getText(Object object) {
		Object labelValue = ((IndexType)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(erdesignerschema30Package.Literals.INDEX_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(erdesignerschema30Package.Literals.INDEX_TYPE__INDEXATTRIBUTE,
					 erdesignerschema30Factory.eINSTANCE.createIndexattributeType())));
	}

...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.rdbmdl.view.ReferencedViewColumn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferencedViewColumnItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferencedViewColumn_refColumn_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferencedViewColumn_refColumn_feature", "_UI_ReferencedViewColumn_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReferencedViewColumn"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ReferencedViewColumn_type") :
			getString("_UI_ReferencedViewColumn_type") + " " + label;
	}

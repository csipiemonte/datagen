...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.rdbmdl.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RdbmdlPackage.Literals.SCHEMA__ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Schema.class)) {
			case RdbmdlPackage.SCHEMA__ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RdbmdlPackage.Literals.SCHEMA__ELEMENTS,
				 RdbmdlFactory.eINSTANCE.createTable()));

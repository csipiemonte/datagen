...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.rdbmdl.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_parent_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_parent_feature", "_UI_Element_type"),
				 RdbmdlPackage.Literals.ELEMENT__PARENT,
				 true,
				 false,
				 true,
				 null,

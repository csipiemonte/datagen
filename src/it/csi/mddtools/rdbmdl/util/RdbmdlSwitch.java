 ...
 * @generated
 */
public class RdbmdlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RdbmdlPackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RdbmdlPackage.NAMED_COLUMN_SET: {
			...
			case RdbmdlPackage.NAMED_ELEMENT: {
			...
			case RdbmdlPackage.SCHEMA_ELEMENT: {
			...
			case RdbmdlPackage.TABLE_COLUMN: {

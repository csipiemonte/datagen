...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.rdbmdl.view.ViewExpressionColumn} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewExpressionColumnItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ViewExpressionColumn_expression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ViewExpressionColumn_expression_feature", "_UI_ViewExpressionColumn_type"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ViewExpressionColumn"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ViewExpressionColumn_type") :
			getString("_UI_ViewExpressionColumn_type") + " " + label;
	}

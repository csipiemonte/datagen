...
/**
 * This is the item provider adapter for a {@link it.csi.mddtools.datagen.Erdesignerschema30.TableType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TableType_comment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TableType_comment_feature", "_UI_TableType_type"),
				 erdesignerschema30Package.Literals.TABLE_TYPE__COMMENT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 erdesignerschema30Package.Literals.TABLE_TYPE__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 erdesignerschema30Package.Literals.TABLE_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 erdesignerschema30Package.Literals.TABLE_TYPE__SCHEMA,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(erdesignerschema30Package.Literals.TABLE_TYPE__PROPERTY);
			childrenFeatures.add(erdesignerschema30Package.Literals.TABLE_TYPE__ATTRIBUTE);
			childrenFeatures.add(erdesignerschema30Package.Literals.TABLE_TYPE__INDEX);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(erdesignerschema30Package.Literals.TABLE_TYPE__PROPERTY,
				 erdesignerschema30Factory.eINSTANCE.createPropertyType()));

		newChildDescriptors.add
			(createChildParameter
				(erdesignerschema30Package.Literals.TABLE_TYPE__ATTRIBUTE,
				 erdesignerschema30Factory.eINSTANCE.createAttributeType()));

		newChildDescriptors.add
			(createChildParameter
				(erdesignerschema30Package.Literals.TABLE_TYPE__INDEX,
				 erdesignerschema30Factory.eINSTANCE.createIndexType()));
	}
